...
Environment:
	* Install Anaconda
	* Create environment (choose one of the two methods):
		- conda create -n ml-hw1 python numpy pandas matplotlib jupyter notebook scikit-learn
		- conda env create -f ml-hw1.yml